...
export default function CartPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 mt-">
      {/* Header */}
      <div className="flex justify-between items-center mb-6">
        ...
        {items.length > 0 && (
          <button
            ...
            className="px-4 py-2 rounded bg-gray-200 hover:bg-gray-400 transition-colors"
          >
      ...
      {items.length > 0 && (
        <div className="mt-6 p-6 bg-gray-100 rounded-lg shadow-md flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <Link to="/checkout" className="w-full sm:w-auto">
            <button className="w-full sm:w-64 px-6 py-3 rounded bg-green-300 text-white text-lg font-semibold hover:bg-green-400 transition-colors">
              Proceed to Checkout
            </button>
          </Link>
        </div>
