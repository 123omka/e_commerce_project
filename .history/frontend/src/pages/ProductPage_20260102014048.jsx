...
export default function ProductPage() {
  ...
  return (
    <>
     {/* 🔥 TOP IMAGE (50% SCREEN) */}
      <div className="relative h-[50vh] w-full bg-[url('/background.jpg')] bg-cover bg-center ">
        {/* overlay */}
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              {products.map((p) => (
                <div
                  key={p.id}
                  className="bg-white relative bg-white/30 backdrop-blur-md rrounded-xl shadow-md hover:shadow-xl transition overflow-hidden flex flex-col"
                >
