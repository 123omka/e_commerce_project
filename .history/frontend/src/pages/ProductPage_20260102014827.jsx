  ...
  return (
    <>
      ...
      <div className="relative h-[50vh] w-full">
        ...
        {/* Bottom half blurred */}
        <div
          className="absolute bottom-0 left-0 w-full h-1/2 bg-cover bg-center filter blur-md"
          style={{ backgroundImage: "url('/background.jpg')" }}
        ></div>
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              {products.map((p) => (
                <div
                  key={p.id}
                  className="relative bg-white/30 backdrop-blur-md rounded-xl shadow-md hover:shadow-xl transition overflow-hidden flex flex-col"
                >
