      ...
      <div className="flex justify-between items-center mb-6">
        ...
        {items.length > 0 && (
          <button
            ...
            className="px-4 py-2 rounded bg-gray-500 hover:bg-yellow-600 transition-colors"
          >
          ...
          <div className="flex-1">
            <div className="flex justify-between items-center">
              ...
              <button
                ...
                className="px-2 py-1 rounded bg-gray-200  hover:bg-gray-600 transition-colors text-sm"
              >
               ✕
              </button>
            </div>
