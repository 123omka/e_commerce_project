...
export default function ProductPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-10 px-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 max-w-[3000px] mx-auto justify-center">
        {products.map((p) => (
          <div
            key={p.id}
            className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-shadow duration-300 flex flex-col min-w-[500px]"
          >
            {/* Image Box */}
