...
export default function ProductPage() {
  ...
  return (
    <div className="max-h-screen bg-gray-100 py-10 px-4">
      <h1 className="text-4xl font-extrabold text-center text-green-600 mb-12">
        Products
      </h1>

      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 max-w-[1800px] mx-auto justify-center">
        {products.map((p) => (
          <div
            key={p.id}
