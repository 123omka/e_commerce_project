...
export default function ProductPage() {
  ...
  return (
   <div className="grid grid-cols-[repeat(auto-fit,minmax(360px,1fr))] gap-10 mt-20 max-w-[1800px] mx-auto justify-center">
  {products.map((p) => (
    <div
      key={p.id}
    ...
    >
      ...
      <div className="px-6 py-5 flex flex-col flex-1">
        ...
        <p className="text-xl font-bold text-green-600 mb-2">₹{p.price}</p>
