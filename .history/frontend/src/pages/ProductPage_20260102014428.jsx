...
<div className="relative h-[50vh] w-full">
  {/* Sharp top half */}
  <div className="absolute top-0 left-0 w-full h-1/2 bg-[url('/background.jpg')] bg-cover bg-center"></div>

  {/* Blurred bottom half */}
  <div className="absolute bottom-0 left-0 w-full h-1/2 bg-[url('/background.jpg')] bg-cover bg-center filter blur-md"></div>
