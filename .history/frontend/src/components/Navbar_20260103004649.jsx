...
export default function Navbar() {
  ...
  return (
    <>
    <nav className="h-[100px] max-w-screen flex items-center justify-between px-10 bg-white shadow-md">

      {/* Left - Logo + Brand */}
      <div className="flex items-center gap-3">
        <div className="w-12 h-12 rounded-xl ml-[150px] bg-gray-200 flex items-center justify-center shadow">
      ...
      <div className="flex items-center gap-6 mr-[150px] text-gray-900 text-lg">

        {/* Icons */}
        <Link to="/cart"
         className="w-6 h-6 hover:text-yellow-500 cursor-pointer" >
