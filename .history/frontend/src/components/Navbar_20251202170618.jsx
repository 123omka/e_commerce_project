  ...
  return (
    <nav className=" h-[100px]  flex items-center justify-between p-4  bg-white text-gray-900 shadow-md">
      ...
      <div className="flex items-center space-x-2 m-[150px]">
        {/* Logo box */}
        <div className="w-10 h-10 bg-yellow-500 rounded flex items-center justify-center text-gray-900 font-bold shadow">
          <img
            src="/brand-logo.png"
            alt="Illustration"
            className=""
        ...
        {/* Brand name */}
        <div className="font-bold text-2xl">ModaElite</div>
      </div>
