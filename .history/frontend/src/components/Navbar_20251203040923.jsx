...
import Navbarpanal from "../components";
  ...
  return (
    ...
    <nav className="h-[100px] flex items-center justify-between px-10 bg-white shadow-md">
      ...
      <div className="flex items-center gap-3">
        <div className="w-12 h-12 rounded bg-gray-200 flex items-center justify-center shadow">
          <img src="/brand.png" alt="Logo" className="w-full h-full" />
        </div>
      ...
      <div className="flex items-center gap-6 text-gray-900 text-lg">
