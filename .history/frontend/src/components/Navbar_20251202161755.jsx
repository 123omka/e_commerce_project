...
export default function Navbar() {
  ...
  return (
    <nav className="flex items-center justify-between p-4 bg-blue-900 text-gray-100">
      {/* Brand name + logo */}
      <div className="flex items-center space-x-2">
        {/* Logo box */}
        <div className="w-8 h-8 bg-yellow-400 rounded flex items-center justify-center text-blue-900 font-bold">
          M
        </div>
        {/* Brand name */}
      ...
      <div className="space-x-4">
        {!token ? (
          <>
            <Link to="/signup" className="hover:text-yellow-400 transition-colors duration-200">
              Signup
            </Link>
